...
Controller = function ( template, actions ) {
  ...
  for ( var action in actions ) {
    if ( Controller._convertActionToTemplateMethod[action] ) {
      Template[template][Controller._convertActionToTemplateMethod[action]](actions[action]);
    } else {
 ...
 */
Controller._convertActionToTemplateMethod = {
  created: 'onCreated',
  rendered: 'onRendered',
